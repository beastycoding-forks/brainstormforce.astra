...
( function( $ ) {
	...
	wp.customize( 'astra-settings[header-offcanvas-content-alignment]', function ( value ) {
        value.bind( function ( newval ) {
			...
			var icon_flot = (menu_content_alignment == 'left' ? 'right' : 'left');

			dynamicStyle += '.content-align-' + newval + ' .main-header-menu .menu-item-has-children>.ast-menu-toggle::before{';
			dynamicStyle += 'float: ' + icon_flot + ';';
			dynamicStyle += '} ';
