	...
	function init( mobileHeaderType ) {
		...
		if ( 'off-canvas' === mobileHeaderType ) {
			...
			for ( link = 0, len = popupLinks.length; link < len; link++ ) {
				if( null !== popupLinks[link].getAttribute("href") && popupLinks[link].getAttribute("href").startsWith('#') && ! popupLinks[link].parentElement.classList.contains('menu-item-has-children') ){
			...
			if( mobileDropdownContent ) {
				...
				for ( link = 0, len = mobileLinks.length; link < len; link++ ) {
					if( null !== mobileLinks[link].getAttribute("href") && mobileLinks[link].getAttribute("href").startsWith('#') && !mobileLinks[link].parentElement.classList.contains('menu-item-has-children') ){
