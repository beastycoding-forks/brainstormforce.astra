...
describe( 'to test full width/stretched container width in the customizer', () => {
	it( 'full width/stretched container width should apply correctly on post', async () => {
	...
	it( 'full width/stretched container width should apply correctly on page', async () => {
	...
	it( 'full width/stretched container width should apply correctly on  archive posts', async () => {
