...
switch ( $astra_header_component_slug ) {
	...
	case 'mode-switcher':
		$is_tooltip_enable = ( class_exists( 'Astra_Ext_Extension' ) && Astra_Ext_Extension::is_active( 'dark-mode-switch' ) && true === astra_get_option( 'header-mode-switcher-icon-tooltip', false ) ) ? true : false;
		$tooltip_data_html = ( $is_tooltip_enable ) ? 'data-light-tooltip-message=' . esc_html( astra_get_option( 'mode-switcher-light-tooltip-message' ) ) . ' data-dark-tooltip-message=' . esc_html( astra_get_option( 'mode-switcher-dark-tooltip-message' ) ) . ' data-tooltip-direction=' . esc_html( astra_get_option( 'header-mode-switcher-flash-message-position', 'left' ) ) . ' ' : '';
		...
		?>
			<div class="ast-builder-layout-element<?php echo esc_attr( $astra_switcher_classes ); ?>" data-section="header-section-mode-switcher" <?php echo esc_attr( $tooltip_data_html ); ?>>
