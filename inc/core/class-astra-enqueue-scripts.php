		...
		public function enqueue_scripts() {
			...
			if ( Astra_Builder_Helper::is_component_loaded( 'mode-switcher', 'header' ) ) {
				$astra_mode_switcher_localize = array(
					...
					'switchToDarkMode'    => apply_filters( 'astra_dark_mode_switcher_text', __( 'Switch to dark mode', 'astra' ) ),
					'switchToLightMode'   => apply_filters( 'astra_light_mode_switcher_text', __( 'Switch to light mode', 'astra' ) ),
