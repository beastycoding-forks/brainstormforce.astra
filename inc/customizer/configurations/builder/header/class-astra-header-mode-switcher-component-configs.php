			...
			$_configs = array(
				...
				*/
				...
				array(
					...
					'choices'    => array(
						'header-light-switcher-1' => 'header-light-switcher-1',
						'header-light-switcher-2' => 'header-light-switcher-2',
						'header-light-switcher-3' => 'header-light-switcher-3',
						'header-light-switcher-4' => 'header-light-switcher-4',
					),
