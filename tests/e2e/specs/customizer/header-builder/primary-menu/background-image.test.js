	...
	it( 'background image for mobile and tablet should apply corectly', async () => {
		const primaryMenuImage = {
			'header-mobile-menu-bg-obj-responsive': {
				...
				tablet: {
					'background-image': 'https://pd.w.org/2022/03/401623b5048758891.48097779-300x206.jpg',
					'background-repeat': 'no-repeat',
					'background-position': 'left top',
					'background-size': 'cover',
					'background-attachment': 'fixed',
				...
				mobile: {
					'background-image': 'https://pd.w.org/2022/03/15762393013cdd6f4.81525438-300x225.jpg',
					'background-repeat': 'no-repeat',
					'background-position': 'left top',
					'background-size': 'cover',
					'background-attachment': 'fixed',
